...
<body>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 12.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Hug.mp3');
    ...
    const fullMessage = `"Setiap langkah, sekecil apa pun, tetaplah berarti 🤍. Tidak perlu membandingkan diri dengan orang lain, karena setiap orang punya jalannya masing-masing 🌼. Tidak apa-apa jika hari ini hanya bisa melakukan sedikit, yang penting adalah tetap bergerak dan tidak berhenti 🌻. Rintangan bukanlah alasan untuk menyerah, tapi tanda bahwa perjalanan ini berharga untuk diperjuangkan 🌈. Percayalah, semua usaha yang dilakukan sekarang akan berbuah di waktu yang tepat 🤍."`;
